...
select d.continent, d.location, d.date, d.population, v.new_vaccinations, sum(new_vaccinations) over (partition by d.location) as roll_add  from covid_deaths  d
...
select d.continent, d.location, d.date, d.population, v.new_vaccinations,  from covid_deaths  d
inner join covid_vaccinatoins v
on d.location=v.location
and d.date=v.date
where d.continent!=''
